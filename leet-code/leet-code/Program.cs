// See https://neetcode.io/practice


Console.WriteLine("Hello, Leetcode!");

//ContainsDuplicated.ContainsDuplicate();

//Console.WriteLine("Anagram = " + Anagram.IsAnagram3("anagram2", "nagaram").ToString());

//Console.WriteLine("TwoSum=" + TwoSum.Calculate2(new int[] { 2, 7, 11, 15 }, 9));
//Console.WriteLine("TwoSum=" + TwoSum.Calculate2(new int[] { 3, 2, 4 }, 6));
